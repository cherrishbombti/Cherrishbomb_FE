  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <p className="text-xs text-gray-500 bg-gray-50 rounded-xl p-4">비상연락망을 불러오지 못했습니다.</p>
      ) : contacts.length === 0 ? (
        ...
        <ul className="flex flex-col gap-2">
          {contacts.map((contact, index) => (
            <li key={contact.contactId} className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-800">
                  ...
                  {contact.relationship && <span className="text-gray-500 font-normal"> · {contact.relationship}</span>}
                </p>
